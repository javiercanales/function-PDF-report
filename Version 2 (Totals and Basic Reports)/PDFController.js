...
const generatePDFv2 = require('../services/generate-pdf-v2.js').generatePDFv2;
...
module.exports = {
    ...
    reportPDFv2: async function (req, res) {
        ...
        generatePDFv2(data, columns, business, user, report, index).then((pdf) => {
            res.set({
