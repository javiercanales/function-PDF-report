...
const generatePDFv1 = require('../services/generate-pdf.js').generatePDFv1;
const generatePDFv1p1 = require('../services/generate-pdf.js').generatePDFv1p1;
...
module.exports = {
    reportPDF: async function (req, res) {
        ...
        // but not set headers names or column widths
        const columns2 = {
            _id: {},
            about: {
                header: 'Sobre',
        ...
        generatePDFv1(data1, columns, business, user, report, index).then((pdf) => {
            res.set({
