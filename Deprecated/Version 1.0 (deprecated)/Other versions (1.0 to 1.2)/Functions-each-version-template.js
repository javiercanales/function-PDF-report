 ...
 * and cuts the cells if there's wrap content, obtaining a simplist version to handle quick reports.
 ...
 * The HTML is generated by a EJS template (HTML with JS embebbed)
 * @Version {1.1}: This version allows to generate reports allowing
 * wrap content if it's needed, and variable size of columns (thanks to the wrap function),
