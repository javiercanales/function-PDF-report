...
module.exports = {
    ...
    generatePDFv1Legacy: async function (data, columns, business, user, report, index) {
        let d = new Date();
        const day = d.getDate();
        const month = d.getMonth() + 1; //Month starts from 0
        const year = d.getFullYear();
        ...
        */
        ...
        let includeIndex;
        if (!index) {
            includeIndex = false; // If there's no index defined
        } else {
            includeIndex =  index.includeIndex; // If index is defined
        }
